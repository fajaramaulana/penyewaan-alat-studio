<div class="container">
	<h1 class="well"><center>Daftar Akun</center></h1>
			...
			if(isset($_POST['signup'])){
				...
				if(!$error){
					if(mysqli_num_rows($query) > 0){
						echo "<div class='alert alert-danger'>Email $email sudah ada, mohon menggunakan email yang lain!</div>";
					}else{
						...
						$query =  "INSERT INTO members (fullname, gender, `address`, city, `state`, zip_code, phone, email, `password`, reg_date) 
						VALUES ('$name','$gender','$address','$city','$state','$zip','$phone','$email','$pass','$regdate')";
	...
	<div class="well"><p class="text-center new-account">Sudah punya akun? <a href="../index.php?p=login">Masuk</a></p></div>
</div>