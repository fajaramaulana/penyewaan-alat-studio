...
<head>
	...
	<title>Daftar Kontak Client | Ornamen Inti Makmur</title>
	...
	<div id="wrapper">
			...
			<ul class="sidebar-nav">
				...
				<li class="sidebar-child"><a href="#"><i class="fa fa-th"></i>Laporan<i class="sidebar-fa fa fa-angle-down pull-right"></i></a>
					<ul class="sidebar-second-child" style="display:block;">
						...
						<li class="active"><a href="customer_report.php">Daftar Kontak Client</a></li>
					</ul>
				</li>
		...
		<div id="page-content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-xs-6">
						<h1 class="logo-img">Ornamen Inti Makmur</h1>
					</div>
					<div class="col-xs-6 text-right" style="margin-top: 10px;">
						...
						Email : Production@ornamen.co.id<address>
					</div>
					<div class="col-lg-12">
						<center><h1>Daftar Kontak Client</h1></center>
