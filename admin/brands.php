...
<head>
	...
	<title>Kelola Data Client | Ornamen Inti Makmur</title>
	...
	<div id="wrapper">
		<aside id="sidebar-wrapper">
			<ul class="sidebar-nav">
				...
				<li><a href="order_confirmation.php"><i class="fa fa-shopping-cart"></i>Kelola Data Pesanan</a></li>
				<li class="sidebar-child"><a href="#"><i class="fa fa-th"></i>Produk Manager<i class="sidebar-fa fa fa-angle-down pull-right"></i></a>
					<ul class="sidebar-second-child" style="display:block;">
						<li class="active"><a href="brands.php">Kelola Data Client</a></li>
							...
							<div class="col-lg-12">
								...
								if (isset($_POST['save'])) {
									...
									if ($_SERVER['REQUEST_METHOD'] == "POST") {
										if (empty($_POST['brand_name'])) {
											...
											if (!preg_match("/^[a-zA-Z0-9 .\-]+$/i", $_POST['brand_name'])) {
												$error = true;
												$brandErr = "Isi nama vendor atau client harus menggunakan angka, huruf, karakter dan spasi";
											}
										}
									...
									if (!$error) {
										if (mysqli_num_rows($query) > 0) {
											echo "<div class='alert alert-danger'>Vendor atau Client <b>$brand</b> sudah ada!</div>";
										} else {
											if (strlen($logo) > 0) {
								...
								<form action="?act=add" class="form-horizontal" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label class="col-md-2 control-label">Nama Vendor atau Client <i>(required)</i></label>
										<div class="col-md-10">
											<input type="text" name="brand_name" placeholder="Masukkan isi nama vendor atau client" class="form-control" value="<?php echo isset($brand) ? $brand : ' '; ?>">
							...
							<div class="col-lg-12">
								...
								if (isset($_POST['update'])) {
									...
									if ($_SERVER['REQUEST_METHOD'] == "POST") {
										...
										if (empty($_POST['brand_name'])) {
											$error = true;
											$brandErr = "Masukkan isi nama vendor atau client";
										} else {
								...
								<form action="?act=edit&id=<?php echo $_GET['id']; ?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
									<legend>Edit Vendor atau Client</legend>
									<!-- Brand Name -->
									<div class="form-group">
										<label class="col-md-2 control-label">Nama Vendor atau Client <i>(required)</i></label>
										<div class="col-md-10">
