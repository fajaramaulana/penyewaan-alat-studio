...
<head>
	...
	<title>Kelola Data Pemesanan | Ornamen Inti Makmur</title>
	...
	<!-- Favicon -->
	<link rel="shortcut icon" type="image/png" href="../logo/ornamen1.png" />
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a href="#" class="navbar-brand"><img src="../logo/ornamen1.png" /></a>
			</div>
	...
	<div id="wrapper">
		<aside id="sidebar-wrapper">
			<ul class="sidebar-nav">
				...
				<li class="active"><a href="order_confirmation.php"><i class="fa fa-shopping-cart"></i>Kelola Data Pesanan</a></li>
				<li class="sidebar-child"><a href="#"><i class="fa fa-th"></i>Produk Manager<i class="sidebar-fa fa fa-angle-down pull-right"></i></a>
					<ul class="sidebar-second-child">
						<li><a href="brands.php">Kelola Data Client</a></li>
						<li><a href="product.php">Kelola Data Paket</a></li>
						<li><a href="categories.php">Kelola Data Survei Kepuasan Client</a></li>
					</ul>
				</li>
				<li class="sidebar-child"><a href="#"><i class="fa fa-th"></i>Laporan<i class="sidebar-fa fa fa-angle-down pull-right"></i></a>
					<ul class="sidebar-second-child">
						<li><a href="item_report.php">Laporan Data Paket</a></li>
						<li><a href="item_catsubcat_report.php">Laporan Data Paket Berdasarkan Kategori / Subkategori</a></li>
						...
						<li><a href="customer_report.php">Daftar Kontak Client</a></li>
					</ul>
				</li>
							...
							<div class="col-lg-12">
								...
								if (isset($_POST['update'])) {
									...
									if (!$error) {
										...
										$updateSql = mysqli_query($conn, "UPDATE orders SET payment_status ='APPROVED', order_status='" . $order . "', order_date = '" . $regdate . "' WHERE order_id='" . $id . "'");
										if($updateSql){
								...
								<form action="?act=edit&id=<?php echo $_GET['id']; ?>" class="form-horizontal" method="POST">
									<legend>Ubah Status Pesanan</legend>
									<!-- Category Name -->
									<div class="form-group">
										<label class="col-md-2 control-label">Kode Pemesanan : </label>
										<div class="col-md-10">
											<label class="control-label" style="font-size:16px;">000<?php echo $data['order_id']; ?></label>
									...
									<div class="form-group">
										<label class="col-md-2 control-label">Status Pesanan : </label>
										<div class="col-md-10">
											<div class="checkboxcss">
												<?php
												if ($data['order_status'] == "PENDING") {
													echo '<input type="radio" name="orderstatus" value="PENDING" checked>PENDING ';
													echo '<input type="radio" name="orderstatus" value="CONFIRM">CONFIRM ';
												} elseif ($data['order_status'] == "SENT") {
													echo '<input type="radio" name="orderstatus" value="PENDING">PENDING ';
													echo '<input type="radio" name="orderstatus" value="CONFIRM" checked>CONFIRM ';
												} else {
													echo '<input type="radio" name="orderstatus" value="PENDING">PENDING ';
													echo '<input type="radio" name="orderstatus" value="CONFIRM">CONFIRM ';
												}
								...
								<div class="col-lg-12" style="margin-bottom:40px;">
									...
									?>
										<div class="col-xs-12 text-center">
											...
											<center>
												<h5>No pemesanan : <?php echo $_GET['id']; ?></h5>
											</center>
										</div>
										<hr>
										<div class="row" style="margin-bottom: 10px;">
									...
									<div class="col-lg-12">
										...
										<div style="margin-top:3%;">
											<p>Terima kasih atas kepercayaan Anda pada Ornamen Inti Makmur, kami senang Anda telah memilih Ornamen Inti Makmur menjadi bagian momen Anda dan kami berharap dapat melayani Anda kembali.</p>
										</div>
									</div>
								</div>
							</div>
			...
			?>
				...
				<footer class="footer-bottom">
					<div class="footer-right">
						&copy; 2021 Ornamen Inti Makmur. All Rights Reserved
					</div>
					<div class="clearfix"></div>
				</footer>
