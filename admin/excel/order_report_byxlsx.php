...
$objDrawing -> setPath('../../logo/ornamen1.png');
...
$activesheet -> setCellValue('F2', 'Jl.Pepaya No 22 Margonda Depok')
				  -> setCellValue('F3', 'Telepon : 021 78892012')
				  -> setCellValue('F4', 'Email : Production@ornamen.co.id');
