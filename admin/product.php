...
<head>
	...
	<title>Kelola Data Paket | Ornamen Inti Makmur</title>
...
<body>
	...
	<div id="wrapper">
			...
			<ul class="sidebar-nav">
				...
				<li class="sidebar-child"><a href="#"><i class="fa fa-th"></i>Produk Manager<i class="sidebar-fa fa fa-angle-down pull-right"></i></a>
					<ul class="sidebar-second-child" style="display:block;">
						...
						<li class="active"><a href="product.php">Kelola Data Paket</a></li>
		...
		<?php
							...
							$item = $cat = $scat = $bgImg = $image = $size = $detail = $matcar = $price = $disc = $stock = $available = "";
		...
		<?php
					...
					$item = $cat = $scat = $size = $desc = $price = $detail = $matcar = $stock = $available = "";
					...
					if(isset($_POST['update'])){
						...
						if(!$error){
							...
							mysqli_query($conn,"UPDATE items SET item_name='$item', cat_id='$cat', scat_id='$scat', size='$size', detail='$detail', material_care = '$matcar', price='$price', discount='$disc', stock='$stock', available ='$available' WHERE item_id='".$id."'");
							header('location: product.php');
						}
					}
