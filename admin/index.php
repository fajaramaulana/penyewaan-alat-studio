	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6 col-md-4 col-md-offset-4">
				<!-- Logo -->
				<img class="logo-title" src="../logo/ornamen1.png" />
				<!-- Form -->
				...
				<p class="text-center new-account">Belum punya akun? <a href="?signup">Buat akun baru</a></p>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6 col-md-4 col-md-offset-4">
				...
				<p class="text-center new-account">Sudah punya akun? <a href="/ornamen/admin/index.php">Masuk</a></p>
			</div>
		</div>
	</div>
<?php
...
?>
		...
		<div class="row">
			<div class="col-sm-6 col-md-4 col-md-offset-4">
				...
				<p class="text-center new-account">Sudah punya akun? <a href="index.php">Masuk</a></p>
				<p class="text-center new-account">Belum punya akun? <a href="?signup">Buat akun baru</a></p>
			</div>
		</div>
	</div>
