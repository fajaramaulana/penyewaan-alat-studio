...
<head>
	...
	<title>Laporan Data Paket Berdasarkan Kategori dan Subkategori | Ornamen Inti Makmur</title>
			...
			<ul class="sidebar-nav">
				...
				<li class="sidebar-child"><a href="#"><i class="fa fa-th"></i> Produk Manager <i class="sidebar-fa fa fa-angle-down pull-right"></i></a>
					<ul class="sidebar-second-child">
						...
						<li><a href="categories.php">Kelola Data Surevi Kepuasan Client</a></li>
					</ul>
				</li>
				<li class="sidebar-child"><a href="#"><i class="fa fa-th"></i>Laporan<i class="sidebar-fa fa fa-angle-down pull-right"></i></a>
					<ul class="sidebar-second-child" style="display:block;">
						...
						<li class="active"><a href="item_catsubcat_report.php">Laporan Data Paket Berdasarkan Kategori / Subkategori</a></li>
				...
				<div class="row">
					<div class="col-lg-12">
						<form class="form-horizontal">
							<legend>Laporan Data Paket Berdasarkan Kategori dan Subkategori</legend>
							<p>Pencarian data paket menurut kategori dan subkategori</p>
