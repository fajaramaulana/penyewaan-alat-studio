...
<div class="product-detail">
	<div class="container">
		<div class="col-lg-12">
			...
			?>
			<div class="back-right"><a href="../index.php"><i class="fa fa-arrow-left"></i>Kembali</a></div>
				...
				<div class="flexslider">
					<ul class="slides">
						...
						for ($i = 0; $i < count($temp); $i++) {
							echo '<li data-thumb="../miiadmin/img/' . trim($temp[$i]) . '"><div class="thumb-image"><img src="../admin/img/' . trim($temp[$i]) . '" 
			...
			<div class="col-md-8 single-right">
				<form action="../index.php?p=single&id=<?php echo $_GET['id']; ?>" method="POST">
					...
					<input type="submit" name="cart" value="Pesan sekarang" class="btn-checkout-2">
				</form>
