	...
	<div class="container">
		<div class="row">
			...
			if (isset($_GET['invoice'])) {
				$query = "SELECT * FROM orders INNER JOIN members ON members.member_id = orders.customer_id WHERE orders.order_id = '" . $_GET['invoice'] . "'";
			...
			<div class="col-xs-12 text-center">
				...
				<center>
					<h5>Nomor Pemesanan : 000<?php echo $_GET['invoice']; ?></h5>
				</center>
			</div>
			<hr>
		</div>
		...
		<div class="col-lg-12">
			<table class="timetable_sub">
				...
				$query = mysqli_query($conn, "SELECT * from order_detail as od INNER JOIN transaksi as t on t.order_id=od.order_id where od.order_id = '" . $_GET['invoice'] . "'");
				$no = 1;
				...
				?>
					<tr>
						...
						<td>
							...
							<div class="table-column-right" style="margin-left:40px;">
								Kode : <?php echo $row['item_code']; ?><br />
								Nama : <?php echo $row['item_name']; ?><br />
							</div>
						</td>
						<td align="center"><img src="../bukti_transfer/<?php echo $row['bukti']; ?>" class="img-small"></td>
